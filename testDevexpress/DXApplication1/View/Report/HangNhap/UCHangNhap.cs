...
{
    public partial class UCHangNhap : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void InDSDaNhap(string date1,string date2 )
        {
            grC.DataSource = nvC.LayDSHangNhap(date1, date2);
        }
        ...
        public void loadData()
        {
            ...
            grC.DataSource = nvC.LayDSHangNhap(DateTime.Now.ToShortDateString(), DateTime.Now.ToShortDateString());
            ...
            else
            {
                ...
                if (cmbXemTheo.SelectedItem == "Quý")
                {
                    ...
                    else
                    {
                        ...
                        InDSDaNhap(ngayBatDau,ngayKetThuc);
                    }
                ...
                {
                    InDSDaNhap(dtpBatDau.Value.ToShortDateString(), dtpKetThuc.Value.ToShortDateString());
                }
