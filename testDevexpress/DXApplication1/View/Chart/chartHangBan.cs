...
{
    public partial class chartHangBan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void TopSPBanchay(string date1, string date2)
        {
            
            DataTable dt = nvC.BieuDoSPBanChay(date1,date2);
           
            chart1.DataSource = dt;
             sr1 = new Series("Số lượng sản phẩm bán được", ViewType.Bar);
            int dem = 0;
        ...
        public void TopSPDoanhThu(string date1, string date2)
        {
            ...
            chart1.DataSource = dt;
             sr2 = new Series("Doanh thu sản phẩm(VNĐ)", ViewType.Bar);
            int dem = 0;
...

        {
            if (cmbXemTheo.Text == "")
            {
                ...
                {
                    TopSPBanchay("10-10-2000", DateTime.Now.ToShortDateString());
                }
                else
                {
            ...
            else
            {
                ...
                if (cmbXemTheo.SelectedItem == "Quý")
                {
                    ...
                    else
                    {
                        ...
                        {
                            TopSPBanchay(ngayBatDau, ngayKetThuc);
                        }
                        else
                        {
                ...
                else if (cmbXemTheo.SelectedItem == "Tự do")
                {
                    ...
                    if (rdo1.Checked == true)
                    {
                        TopSPBanchay(dtpBatDau.Value.ToShortDateString(), dtpKetThuc.Value.ToShortDateString());
                    }
                    else
                    {
