...
namespace QLhocsinhgiaovien.Model
{
    class connection
    {
        public static string sqlcon = @"Data Source=DESKTOP-4EVF50T\SQLEXPRESS;Initial Catalog=Quanlysinhviengiaovien;Integrated Security=True";
        //@"Data Source=DESKTOP-PHFH3VR\TIENNGUYEN1;Initial Catalog=Quanlysinhviengiaovien;Integrated Security=True";
